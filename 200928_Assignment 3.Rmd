...
What if I wanted to know how many trees are in Boston neighborhoods that are particularly vulnerable to the climate crisis? First, I'll filter the climate vulnerability indicators and see how they compare to green and open space access. 
...
ggplot(max_climate_vulnerability) +
  ...
  geom_sf(color = NA, 
          aes(fill = num_trees)) +
  scale_fill_viridis_c(name = "Boston neighborhoods most vulnerable to \nclimate crisis \nby number of trees",
...
I want to map how public space is distributed in neighborhoods most vulnerable by the climate crisis. 
...
How many neighborhoods vulnerable by the climate crisis have access to open spaces?
...
ggplot(open_space) +
  ...
  annotate(geom = "text", x = left_side, 
           ...
           label = paste(n_os_cvuln ,
                         ...
                         "vulernable neighborhoods have access to \n", 
                         "open space."),
           hjust = 0, vjust = 0, size = 3) +
  theme_map() +
  theme(panel.background = element_rect(fill = "white"),
...
## Hubway stations in climate vulnerable neighborhoods

Now, I'll plot how many hubway stations there are in climate vulnerable neighborhoods. 
...
Density of hubway stations in climate-vulnerable neighborhoods. 
