...
I will now plot population, percent of population that speak english, majority race/ethnicity, and income level. 
...
```
##Plotting percent rate occupied units
 ...
 ggplot(AT_tracts, aes(x=majority_inc, y=pct_eng, fill = majority_inc)) +
    ...
    scale_x_discrete(name = "Majority income",
                       labels = c("Below $25,000",
                                  ...
                                  "No data"))
```
##Area chart of individuals that only speak English
